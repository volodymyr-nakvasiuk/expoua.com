jQuery.fn.addColorPicker = function( props ) {
	...
	props = jQuery.extend({
		colors : [
		"#EBEBEB", "#E6E6E6", "#E0E0E0", "#DBDBDB", "#D6D6D6", "#D0D0D0", "#CBCBCB", "#C6C6C6", "#C0C0C0", "#BBBBBB", "#B6B6B6", "#B0B0B0", 
		"#ABABAB", "#A6A6A6", "#A0A0A0", "#9B9B9B", "#969696", "#909090", "#8B8B8B", "#868686", "#808080", "#7B7B7B", "#767676", "#707070", 
		"#6B6B6B", "#666666", "#606060", "#5B5B5B", "#565656", "#505050", "#4B4B4B", "#464646", "#404040", "#3B3B3B", "#363636", "#303030", 

		"#000000", "#000033", "#000066", "#000099", "#0000CC", "#0000FF", "#330000", "#330033", "#330066", "#330099", "#3300CC", "#3300FF",
...
$(document).mousedown(
  function(event) {
    ...
    if (($target.parents('#col_container').length == 0)) {
      $('#col_container').remove();
    }
