<?php /* Smarty version 2.6.18, created on 2010-12-21 13:11:44
         compiled from controllers/admin_ep_banners_banners/list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'getUrl', 'controllers/admin_ep_banners_banners/list.tpl', 19, false),array('function', 'cycle', 'controllers/admin_ep_banners_banners/list.tpl', 37, false),)), $this); ?>
<?php echo '<h4>Баннера</h4>'; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php echo '<th>Тип: &nbsp;<SELECT name="types_id" onchange="document.location.href = \''; ?><?php echo $this->_plugins['function']['getUrl'][0][0]->getUrl(array('add' => '1','del' => 'search'), $this);?><?php echo 'search/types_id=\' + this.value + \'/\';"><OPTION value="0">(Не выбрано)</OPTION><OPTION value="1">Изображение 180x300</OPTION><OPTION value="2">Изображение 160x80</OPTION><OPTION value="3">Flash 180x300</OPTION><OPTION value="4">Flash 160x80</OPTION><OPTION value="5">Изображение 300x100</OPTION><OPTION value="6">Flash 300x100</OPTION><OPTION value="7">Приоритетная строка выставок</OPTION><OPTION value="8">Текстовый блок</OPTION></SELECT></th><TH align="center" colspan="2">Действия</TH></TR>'; ?><?php $this->assign('npp_base', $this->_tpl_vars['HMixed']->getConfigConstValue('GENERAL_ELEMENTS_PER_PAGE')); ?><?php echo ''; ?><?php $this->assign('npp_base', ($this->_tpl_vars['npp_base']*$this->_tpl_vars['list']['page']-$this->_tpl_vars['npp_base'])); ?><?php echo ''; ?><?php $_from = $this->_tpl_vars['list']['data']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['fe'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['fe']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['el']):
        $this->_foreach['fe']['iteration']++;
?><?php echo '<TR class="'; ?><?php echo smarty_function_cycle(array('values' => "odd,even"), $this);?><?php echo '"><TD align="center">'; ?><?php $this->assign('npp', ($this->_foreach['fe']['iteration']+$this->_tpl_vars['npp_base'])); ?><?php echo ''; ?><?php echo $this->_tpl_vars['npp']; ?><?php echo '</TD><TD align="center">'; ?><?php echo $this->_tpl_vars['el']['id']; ?><?php echo '</TD><TD>'; ?><?php echo $this->_tpl_vars['el']['name']; ?><?php echo '</TD><TD>'; ?><?php echo $this->_tpl_vars['el']['type_name']; ?><?php echo '</TD>'; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
