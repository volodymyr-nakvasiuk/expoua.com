...
<tr class="{cycle values="odd,even"}">
  ...
  <td align="center">{$el.tickets}&nbsp;</td>
  <td align="center"><a href="{getUrl add="1" action="list" parent=$el.id}"><img title="{#captionList#}" src="/images/admin/list-edit.gif" border="0" height="21" width="23"></a>&nbsp;</td>
</tr>
{/foreach}
</table>
