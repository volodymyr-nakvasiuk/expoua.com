...
<TR>
  <TD valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <BR /><BR />  </TD>
<TD width="75%"><textarea name="{$lang.code}[thematic_sections]" id="thematic_sections_{$lang.code}" style="width:99%; height:250px;">{$entry[$lang.code].thematic_sections|escape:"html"}</textarea></TD>
</TR>
