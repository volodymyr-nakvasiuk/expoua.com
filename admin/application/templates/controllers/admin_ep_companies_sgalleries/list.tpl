...
<TR>
 ...
 {include file="common/Lists/headerElementAutocomplete.tpl" name="companies_services_id" controller="admin_ep_companies_services" descr="Услуга/Продукт"}
