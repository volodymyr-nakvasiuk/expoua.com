...
<TR>
 ...
 {include file="common/Lists/headerElementAutocomplete.tpl" name="advertisers_id" controller="admin_ep_banners_advertisers" descr="Рекламодатель"}
...
{foreach from=$list.data item="el" name="fe"}
 <TR class="{cycle values="odd,even"}">
  ...
  <TD><a href="{getUrl controller="admin_ep_banners_plans" action="list" parent=$el.id}">{$el.name}</a></TD>
  <TD>{$el.advertiser_name}</TD>
