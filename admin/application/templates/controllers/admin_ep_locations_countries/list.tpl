<h4>База регионов/стран/городов: Страны</h4>
...
{foreach from=$list.data item="el" name="fe"}
 ...
 <TD><a href="{getUrl controller="admin_ep_locations_cities" parent=$el.id region=$user_params.parent action="list"}">{$el.name}</a></TD>
 </TR>
{/foreach}
</TABLE>