<H4>Список брендов с одинаковыми названиями</H4>
...
<TABLE class="list" width="100%">
 ...
 {foreach from=$list item="el"}
  <TR class="{cycle values="odd,even"}">
   ...
   <TD align="center"><a href="{getUrl controller="admin_ep_brands" action="list" search="name=`$el.name`"}"><img alt="Показать список" src="{$document_root}images/admin/icons/page_text.gif" border="0" width="16"></a></TD>
  </TR>
 {/foreach}
</TABLE>