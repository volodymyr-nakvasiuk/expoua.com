...
<h4>Добавляем новую новость компании</h4>
...
<TABLE border="1" width="100%" style="border-collapse:collapse;">
 ...
 <TR>
  <TD>Страна:</TD>
  <TD><INPUT type="text" size="5" name="countries_id" id="countries_id"> <INPUT type="button" onclick="objCountriesList.showPopUp();" value="Выбрать"> <SPAN id="countries_id_name"></SPAN></TD>
 </TR>
 <TR>
  <TD>Выставка:</TD>
  <TD><INPUT type="text" size="5" name="events_id" id="events_id"> <INPUT type="button" onclick="objEventsList.showPopUp();" value="Выбрать"> <SPAN id="events_id_name"></SPAN></TD>
 </TR>
 <TR>
