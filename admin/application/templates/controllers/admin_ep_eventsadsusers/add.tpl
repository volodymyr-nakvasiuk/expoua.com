...
<TABLE border="1" style="border-collapse:collapse" width="100%">
 <tr>
  ...
  <TD>
   <SELECT name="type">
    ...
    <OPTION value="tour">Туркомпания</OPTION>
 ...
 <TR>
  ...
  <TD><INPUT type="text" name="service_companies_id" id="service_companies_id" size="5"> <INPUT type="button" value="Выбрать" onclick="objServiceCoList.showPopUp();"></TD>
 </TR>
 <TR>
  <TD>Событие:</TD>
  <TD><INPUT type="text" name="events_id" id="events_id" size="5"> <INPUT type="button" value="Выбрать" onclick="objBrandsEventsList.showPopUp();"></TD>
 </TR>
 <TR>
  <TD>Участник:</TD>
  <TD><INPUT type="text" name="events_participants_id" id="events_participants_id" size="5"> <INPUT type="button" value="Выбрать" onclick="objParticipantList.showPopUp();"></TD>
 </TR>
 <TR>
  <TD>Дата с:</TD>
  <TD><INPUT type="text" name="period_date_from" id="period_date_from" size="12"></TD>
 </TR>
 <TR>
  <TD>Дата по:</TD>
  <TD><INPUT type="text" name="period_date_to" id="period_date_to" size="12"></TD>
 </TR>
 <TR>
  <TD>Логин:</TD>
