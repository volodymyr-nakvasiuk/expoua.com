...
Zend_Loader::loadClass("Fulltext_Stemmer_Abstract", PATH_DATAPROVIDERS);
    ...
    * How easy is that?
    *
    * Модифицирован для использования в данной системе. Автору большое спасибо!
    * Оригинальное имя класса PorterStemmer
    */

    class Fulltext_Stemmer_English extends Fulltext_Stemmer_Abstract {
        /**
