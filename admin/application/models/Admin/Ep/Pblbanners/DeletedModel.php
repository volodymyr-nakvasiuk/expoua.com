...
class Admin_Ep_Pblbanners_DeletedModel extends Admin_ListModelAbstract {
	...
	public function updateEntry($id, Array $data) {
		...
		//Зачем обновлять MView? Эти парни давно удалены и никогда не будут показываться больше
		/*if ($res) {
