<?php
class Crud_Form_ExtJs_LocationRegions extends Crud_Form_ExtJs_Tabitem {

	protected $modelName = 'Db_LocationRegions';
	protected $_title = 'Все языки';

	public function init () {
		$this->action = '/' . self::$ajaxModuleName . '/location-regions/save/';
		$this->actionName = 'location-regions';
