<?php
class Crud_Form_ExtJs_LocationCitiesData extends Crud_Form_ExtJs_Tabitem {

	protected $modelName = 'Db_Lang_LocationCitiesData';
	protected $_title = '';

	public function init () {
		$this->action = '/' . self::$ajaxModuleName . '/location-cities-data/save/';
		$this->actionName = 'location-cities-data';
