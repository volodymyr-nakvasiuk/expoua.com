<?php
class Crud_Form_ExtJs_ExpocentersData extends Crud_Form_ExtJs_Tabitem {

	protected $modelName = 'Db_Lang_ExpocentersData';
	protected $_title = '';

	public function init () {
		$this->action = '/' . self::$ajaxModuleName . '/expocenters-data/save/';
		$this->actionName = 'expocenters-data';
