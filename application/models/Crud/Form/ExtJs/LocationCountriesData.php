<?php
class Crud_Form_ExtJs_LocationCountriesData extends Crud_Form_ExtJs_Tabitem {

	protected $modelName = 'Db_Lang_LocationCountriesData';
	protected $_title = '';

	public function init () {
		$this->action = '/' . self::$ajaxModuleName . '/location-countries-data/save/';
		$this->actionName = 'location-countries-data';
