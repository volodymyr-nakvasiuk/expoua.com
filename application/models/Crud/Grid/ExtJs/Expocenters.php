<?php
class Crud_Grid_ExtJs_Expocenters extends ArOn_Crud_Grid_ExtJs {

	protected $_idProperty = 'id';
	public $sort = "id";
	public $direction = "ASC";
	public $editController = 'grid';
	public $editAction = 'expocenters-tab';

	public function init() {
		$this->trash = false;
		$this->gridTitle = 'Выставочные центры';

		$this->gridActionName = 'expocenters';
		$this->table = "Db_Lang_ExpocentersData";
		$this->fields = array(
			'id' => new ArOn_Crud_Grid_Column_Numeric('Id',null,true,false,'50'),
			'city' => new ArOn_Crud_Grid_Column_JoinOne("Город",array('Db_Expocenters','Db_Lang_LocationCitiesData'),'name',null,false,'200'),
			...
			'active' => new ArOn_Crud_Grid_Column_JoinOne('Активный','Db_Expocenters', 'active', null, false, '50'),
		);
		...
		$this->filters->fields = array(
			'search' => new ArOn_Crud_Grid_Filter_Field_Search('search','Search:', array(
				...
				array(
					'path' => array('Db_Expocenters','Db_Lang_LocationCitiesData'),
					'filters' => array(
						ArOn_Db_Filter_Search::NAME => ArOn_Db_Filter_Search::LIKE
					),
				),
